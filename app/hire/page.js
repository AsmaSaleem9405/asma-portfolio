          ...
          {menuOpen && (
            ...
            >
              ...
              <ul className="flex flex-col flex-1 justify-center items-center gap-6 text-lg font-bold text-center -mt-50">
               <li onClick={() => { window.location.href = "/#home"; setMenuOpen(false); }}>
  Home
</li>

<li onClick={() => { window.location.href = "/#about"; setMenuOpen(false); }}>
  About
</li>

<li onClick={() => { window.location.href = "/#services"; setMenuOpen(false); }}>
  Services
</li>

<li onClick={() => { window.location.href = "/#projects"; setMenuOpen(false); }}>
  Projects
</li>

<li onClick={() => { window.location.href = "/#experience"; setMenuOpen(false); }}>
  Experience
</li>
    ...
    {/* FORM SECTION */}
   <div className="relative w-full min-h-screen flex pt-29 pb-19 items-center justify-center px-4 overflow-hidden">

  {/* PURPLE GLOW BACKGROUND */}
  <div className="absolute inset-0 -z-10">
    <div className="absolute w-125 h-125 bg-purple-500 opacity-30 rounded-full blur-3xl top-10 left-10"></div>
    <div className="absolute w-100 h-100 bg-purple-400 opacity-20 rounded-full blur-3xl bottom-10 right-10"></div>
  </div>

  {/* YOUR FORM */}
 <div
  className={`w-full max-w-5xl p-8 rounded-2xl shadow-2xl transition-all duration-300 
  hover:shadow-[0_0_40px_rgba(168,85,247,0.6)] hover:scale-[1.02]
  ${
    darkMode ? "bg-black/70 text-white" : "bg-purple-60 text-gray-900"
  }`}
>
    {/* TITLE */}
...
{!form.name && submitted && (
  <p className="text-red-500 text-sm mt-1">Please fill your name</p>
)}
<input
  name="email"
  value={form.email}
...
{!form.email && submitted && (
  <p className="text-red-500 text-sm mt-1">Please fill your email</p>
)}
...
>
  <option value="+92" className={darkMode ? "bg-black text-white" : "bg-white text-black"}>
    🇵🇰 +92
  </option>
  <option value="+91" className={darkMode ? "bg-black text-white" : "bg-white text-black"}>
    🇮🇳 +91
  </option>
  <option value="+1" className={darkMode ? "bg-black text-white" : "bg-white text-black"}>
    🇺🇸 +1
  </option>
  <option value="+44" className={darkMode ? "bg-black text-white" : "bg-white text-black"}>
    🇬🇧 +44
  </option>
...
>
  ...
  <option value="freelancer" className={darkMode ? "bg-black text-white" : "bg-white text-black"}>
    Freelancer
  </option>

  <option value="full-time" className={darkMode ? "bg-black text-white" : "bg-white text-black"}>
    Full-Time
  </option>

  <option value="part-time" className={darkMode ? "bg-black text-white" : "bg-white text-black"}>
    Part-Time
  </option>

  <option value="contract" className={darkMode ? "bg-black text-white" : "bg-white text-black"}>
    Contract
  </option>
</select>
